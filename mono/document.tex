...
utilizadas C++ para a implementação do servidor e Java para a implementação dos
clientes.  O projeto inteiro foi desenvolvido utilizando-se a ferramenta de
versionamento Git. O código do projeto, modo de instalação e experimentos podem
